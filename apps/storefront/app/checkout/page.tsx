        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="border rounded-lg p-6 bg-card space-y-4">
              ...
              <div className="space-y-3">
                <label className={paymentMethod === 'wechat' ? 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-blue-500 bg-blue-50' : 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-gray-200 hover:border-gray-300'}>
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="wechat"
                ...
                <label className={paymentMethod === 'alipay' ? 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-blue-500 bg-blue-50' : 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-gray-200 hover:border-gray-300'}>
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="alipay"
                ...
                <label className={paymentMethod === 'toss' ? 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-blue-500 bg-blue-50' : 'flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition border-gray-200 hover:border-gray-300'}>
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="toss"
